...
describe('Movies', () => {
  ...
  it('should render', () => {
    const { container } = render(<Movie movie={mockMovie} viewTrailer={mockViewTrailer} toggleWatchLater={mockToggleWatchLater} toggleStarred={mockToggleStarred} />, { wrapper })
    expect(container).toBeDefined();
  })

  it('should add to watch list', () => {
    render(<Movie movie={mockMovie} viewTrailer={mockViewTrailer} toggleWatchLater={mockToggleWatchLater} toggleStarred={mockToggleStarred} />, { wrapper })
  ...
  it('should remove from watch list', () => {
    render(<Movie movie={mockMovie} viewTrailer={mockViewTrailer} watchLater={true} toggleWatchLater={mockToggleWatchLater} toggleStarred={mockToggleStarred} />, { wrapper })
  ...
  it('should remove from starred list', () => {
    render(<Movie movie={mockMovie} viewTrailer={mockViewTrailer} isStarred={true} toggleWatchLater={mockToggleWatchLater} toggleStarred={mockToggleStarred} />, { wrapper })
  ...
  it('should load placeholder image if the poster path is not available', () => {
    render(<Movie movie={{ ...mockMovie, poster_path: null }} viewTrailer={mockViewTrailer} toggleWatchLater={mockToggleWatchLater} toggleStarred={mockToggleStarred} />, { wrapper })
